...
//From https://gist.github.com/gaara87/3607765#gistcomment-832930
//Screens input to only allow for two inputs after the decimal but also allows for change before the decimal
...
public class InputFilterDecimal extends DigitsKeyListener {
    ...
    InputFilterDecimal(int beforeDecimal, int afterDecimal) {
